...
|-----------|-----------|---------------|-----------------|
| Accuracy | "A financial table showing some budget data" (no program name, no values, no institutions) | "Table 9: North Star Promise Program awards for FY2025. 4 institutions, total 11,000 students, $23.2M. Header is dark navy with white text." | "Table 9 with 4 columns (System/Count/Average/Total). MN State Colleges 3,800/$1,260/$4.8M; MN State Universities 2,900/$2,120/$6.1M; U of M 4,400/$2,790/$12.3M; Tribal 10/$1,660/$16.6K; Total 11,000/$2,110/$23.2M. Student count sum (11,110) does not match rounded Total (11,000)." |
| Specificity | "A table with rows and columns" | "4 columns, 6 rows (header + 5 data). Dark navy header, alternating white/gray rows. Dollar amounts with $ and commas." | "Dark navy/teal header (#003B5C). White bold header text wrapping to 2-3 lines. Right-aligned numbers. $X,XXX and $XX,XXX,XXX formatting. 1009x451 px. Thin gray row separators. Professional government budget formatting." |
| Completeness | "Budget table" (misses title, column names, all values, formatting details) | "Title, 4 columns, 4 institutions + total, all dollar values, dark header, alternating rows" | "Full title (Table 9: North Star Promise...). 4 column headers. 5 data rows with all 20 cell values. Alternating row shading. Dark navy header with white text. Right-aligned numbers. Dollar + comma formatting. Sum discrepancy (11,110 vs 11,000) noted. 1009x451 px." |
| Usefulness | "A budget presentation table" | "FY2025 North Star Promise Program awards: $23.2M across 11,000 students at 4 MN institution types. Average award $2,110." | "North Star Promise Program (MN tuition-free college, enacted 2023) FY2025 projections. Last-dollar aid: average $2,110 after other aid applied. U of M largest allocation ($12.3M, 4,400 students). Higher tuition institutions get higher average awards ($2,790 U of M vs $1,260 State Colleges). Total $23.2M is independently projected (does not sum from rows). From MN State FY2025 operating budget presentation." |
