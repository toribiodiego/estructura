...
|-----------|-----------|---------------|-----------------|
| Accuracy | "A table with wing measurements" (no model names, no values, no units) | "ArtPro wing spec table with 6 models (1401-951). Columns: wingspan, chord, mean avg chord, actual area, projected area, volume, aspect ratio. Largest 1401 at 1401mm/12.17 AR." | "6 models (1401/1201/1121/1051/1001/951) with 7 measurement columns. All values in metric+imperial. Model names = wingspan in mm. 1401: 1401mm/170mm chord/115.7mm MAC/1647cm2/1611cm2/1764cm3/12.17 AR. Aspect ratio non-monotonic (1201 lowest at 11.14). Projected area consistently ~2-3% less than actual area." |
| Specificity | "A data table with numbers" | "6 rows, 7+ columns. Dark model number cells, gray headers, alternating row shading. Metric and imperial units." | "Dark charcoal model cells with bold white text. Gray lowercase multi-line headers. Bold first data row. No grid lines or borders. Superscript unit notation (cm2, in3). Minimalist modern design. ~1024x179px WebP." |
| Completeness | "Wing specifications" (misses all values, model names, column structure, styling) | "6 models, 7 columns, all column names listed, flagship 1401 values, alternating rows, dual unit system" | "All 6 models with all 48 data values. 8 columns (unlabeled model + 7 named). Dual metric/imperial for wingspan, chord, area, volume. Metric-only for mean avg chord. 2-decimal aspect ratio. Bold first row. Dark model cells. No title. Minimalist styling." |
| Usefulness | "A product table" | "ArtPro foil wing specs: 6 sizes from 951mm to 1401mm wingspan. Key measurements for comparing wing performance." | "ArtPro SUP/wing foil hydrofoil wings from standupsurfshop.com.au. 6 sizes (951-1401mm). Model number = wingspan in mm. AR range 11.14-12.17 (non-monotonic -- 1201 lowest). Projected < actual area due to wing curvature. Larger wings = more lift/stability at low speed; smaller = more maneuverable." |
